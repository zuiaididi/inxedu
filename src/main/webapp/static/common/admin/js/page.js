...
$(function(){
	$("#pageSize").change(function(){
		...
		$("#pagePageSize").val(pageSize);
		$("#searchForm").submit();
	})
	$("#pageSize option[value='" + $("#pagePageSize").val() + "']").attr("selected","selected");
})
...
function showPageNumber() {
	...
	pageHtml = pageHtml + '<li class="disabled" style="color:#ff0000;"><a href="javascript:void(0)">' + currentPage + '</a></li>';
