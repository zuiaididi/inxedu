									...
									<li>
										<div class="cc-l-wrap">
											<section class="course-img">
												...
												<div class="cc-mask">
													<a href="${ctx}/uc/play/${course.courseId}/0" title="" class="comm-btn c-btn-1">继续学习</a>
												</div>
											</section>
											<h3 class="hLh30 txtOf mt10">
												<a href="${ctx}/uc/play/${course.courseId}/0" title="${course.courseName}" class="course-title fsize18 c-333">${course.courseName}</a>
											</h3>
