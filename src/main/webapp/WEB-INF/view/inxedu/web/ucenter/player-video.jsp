...
<body>
															...
															<li class="lh-menu-stair">
																...
																>
																	<c:forEach items="${parentKpoint.kpointList}" var="sonKpoint">
																		<li class="lh-menu-second ml30" id="${sonKpoint.kpointId}">
																			<a href="javascript:void(0)" onclick="getPlayerHtml(${sonKpoint.kpointId },'${sonKpoint.name }',this)" class="" title="">
																				...
																				</span><em class="lh-menu-i-2 icon14 mr5">&nbsp;</em>${sonKpoint.name }<c:if test="${sonKpoint.isView==1}"><font color="green">&nbsp;（已观看）</font></c:if>
																			</a>
																		</li>
																	</c:forEach>
																</ol>
														...
														<c:if test="${parentKpoint.kpointType==1 }"><!-- 视频 -->
															<li class="lh-menu-stair">
																<ul class="lh-menu-ol no-parent-node">
																	<li class="lh-menu-second" id="${parentKpoint.kpointId}"><a title="" onclick="getPlayerHtml(${parentKpoint.kpointId },'${parentKpoint.name }',this)" href="javascript:void(0)">
																			<span class="fr"> 
																				...
																				</span><em class="lh-menu-i-2 icon14 mr5">&nbsp;</em>${parentKpoint.name }<c:if test="${sonKpoint.isView==1}"><font color="green">&nbsp;（已观看）</font></c:if></a>
																	</li>
																</ul>
															</li>
														</c:if>
					...
					<div class="i-box">
						<div>
							<section class="c-infor-tabTitle c-tab-title">
								<a class="current" title="课程节点评论" href="javascript:void(0);" onclick="comment(1,this)">课程节点评论</a>
	...
	<input type="hidden" id="kpointId" value="${kpointId}" />
