			...
			<div>
				<article class="c-v-pic-wrap">
					<section class="p-h-video-box" id="videoPlay">
						...
						<a href="javascript:void(0)" onclick="if(isLogin() || isLogin2()){ vedioClick(${freeVideoId})} else{lrFun();}" title="${course.courseName}" class="v-play-btn">
							<em class="icon30">&nbsp;</em>
						</a>
					</section>
				...
				<aside class="c-attr-wrap">
					<section class="ml20 mr15">
						...
						<section class="c-attr-mt">
									<a href="javascript:void(0)" title="立即观看" onclick="if(isLogin()  || isLogin2()){window.location.href='/uc/play/${course.courseId }/0'} else{lrFun();}" class="comm-btn c-btn-3">立即观看</a>
							<span class="ml10"><tt class="c-yellow f-fM"></tt></span>
						</section>
															...
															<li class="lh-menu-stair">
																...
																>
																	<c:forEach items="${parentKpoint.kpointList}" var="sonKpoint">
																		<li class="lh-menu-second ml30"><a href="javascript:void(0)" <%-- onclick="playVideo('${sonKpoint.videoUrl }',this)" --%> onclick="if(isLogin() || isLogin2()){getPlayerHtml(${sonKpoint.kpointId },${sonKpoint.free },this)} else{lrFun();}" title="">
																				<span class="fr"> 
														...
														<c:if test="${parentKpoint.kpointType==1 }"><!-- 视频 -->
															<li class="lh-menu-stair">
																<ul class="lh-menu-ol no-parent-node">
																	<li class="lh-menu-second"><a title="" <%-- onclick="playVideo('${parentKpoint.videoUrl }',this)" --%> onclick="if(isLogin()  || isLogin2()){getPlayerHtml(${sonKpoint.kpointId },${sonKpoint.free },this)} else{lrFun();}" href="javascript:void(0)">
																			<span class="fr"> 
