									...
									<li>
										<section class="i-q-l-wrap">
											...
											<section class="hLh20 of">
												...
												<span class="fsize16 c-666">
												 	<c:if test="${empty comment.name }">
									                  <c:if test="${empty comment.studentNumber || comment.studentNumber==''}">
										              <font color="red">${comment.sysUserName}（管理员）</font>
									                  </c:if>
									                  <c:if test="${!empty comment.studentNumber && comment.studentNumber!='' }">
											...
											<section class="hLh20 of mt10">
												...
												<c:if test="${comment.kpointId!=null and comment.kpointId!=0}">
												—
												<a class="c-master fsize14" href="${ctx}/uc/play/${comment.courseId}/${comment.kpointId}">《${comment.kpointName}》</a>
												</c:if>
											</section>
