...
<div class="mt20">
    <div class="commonWrap">
		<form action="/admin/user/importExcel/${classDto.classId}" method="post" id="importP" enctype="multipart/form-data">
				<table width="100%" cellspacing="0" cellpadding="0" border="0" class="commonTab01">
					<caption>&nbsp;</caption>
					<tbody>
						<tr>
						<td align="center"><font color="red">*</font>&nbsp;班级</td><br>
						<td>${classDto.collegeName}-${classDto.majorName}-${classDto.gradeName}级-${classDto.className}班</td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						...
						<tr><td>&nbsp;</td></tr>
							...
							<td>excel模版说明：<br>
                                第一列：用户的学号,必须是未注册过的，不能为空<br>   
                                第二列：用户的姓名<br> 
                                第三列：密码 如不填写默认为学号,不得填入非法字符例如“. * #”,长度6-20位<br>
