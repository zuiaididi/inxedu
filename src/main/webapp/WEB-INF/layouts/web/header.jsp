		...
		<section class="u-m-dd">
			...
			<ul>
				<li>
					<span>Wo的记录</span>
					<ol>
					    <li><a href="javascript:void(0)" onclick="mobileHrefCheckLogin('${ctx}/uc/courseHistory')" title="">课程浏览记录</a></li>
					    <li><a href="javascript:void(0)" onclick="mobileHrefCheckLogin('${ctx}/uc/testHistory')" title="">测验记录</a></li>
					    <li><a href="javascript:void(0)" onclick="mobileHrefCheckLogin('${ctx}/uc/chosecourse/1')" title="">选课记录</a></li>
					</ol>
				</li>
			</ul>
		</section>
