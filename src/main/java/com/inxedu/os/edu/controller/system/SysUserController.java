...
public class SysUserController extends BaseController {
	...
	@RequestMapping("/ajax/seekSysUser")
	@ResponseBody
	public List<SysUser> seekSysUser(HttpServletRequest request){
		try {
			...
			if(sysId == 1){
				List<SysUser> sysUserList = sysUserService.querySysUserByRoleId(2);
				SysUser sysUser = sysUserService.querySysUserByUserId(sysId);
			...
			logger.error("SysUserController.seekSysUser()",e);
