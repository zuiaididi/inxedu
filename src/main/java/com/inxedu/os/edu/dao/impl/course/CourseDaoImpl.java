...
public class CourseDaoImpl extends GenericDaoImpl implements CourseDao {
	...
	public List<Course> queryCourseBySysUser(int sysUserId){
		return this.selectList("CourseMapper.queryCourseBySysUser", sysUserId);
	}
	...
	public void deleteCourse(int courseId) {
		this.delete("CourseMapper.deleteCourse", courseId);
	}
