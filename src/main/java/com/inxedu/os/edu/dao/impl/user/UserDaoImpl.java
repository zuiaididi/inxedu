...
public class UserDaoImpl extends GenericDaoImpl implements UserDao{
	...
	public int checkNumber(String number) {
		return this.selectOne("UserMapper.checkNumber", number);
	}
	
	public int queryUserIdByStudentNumber(String number){
		return this.selectOne("UserMapper.queryUserIdByStudentNumber", number);
	}
	
	public int getClassNumber(int classId){
		return this.selectOne("UserMapper.getClassNumber", classId);
	}
	...
	public int queryUserCountByClass(int clazzId){
		return this.selectOne("UserMapper.queryUserCountByClass", clazzId);
	}

	
	public User queryUserByEmailOrMobile(String emailOrMobile) {
		return this.selectOne("UserMapper.queryUserByEmailOrMobileOrNumber", emailOrMobile);
	}
