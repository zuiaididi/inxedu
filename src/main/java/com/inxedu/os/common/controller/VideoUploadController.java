...
//    {
//	    String s = it.next();
//	    System.out.println("requestFile:" + s);
...
//		System.out.println(originalFilename + "*" + ext);
//		fileName = UUID.randomUUID().toString();
//		
//		File tf = new File("image/", fileName + ext);
//		try 
//		{
//			FileUtils.copyInputStreamToFile(file.getInputStream(), tf);
//		}
//		catch (IOException e) 
//		{
//			e.printStackTrace();
//		}
//		path = tf.getPath() + "*" + tf.getAbsolutePath() + "*" + "*" +
//				tf.getName();
//    }
